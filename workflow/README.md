...
## New python env on savio

```
module load anaconda3/2024.02-1-11.4
conda config --set solver libmamba
conda create --name=WRF2 ipykernel python=3.10
source activate WRF2
python -m ipykernel install --user --name WRF2

## for some reason install python 3.11 and netcdf break jupyter kernal on savio???? so am using 3.10. Adam also mentioned not to use 3.11
```
...
```
## This wrf is default wrfv4.2 we will transition to GAD-DRM once we get workflow working 
...
## MAIN WPS So far from Elius
/global/scratch/users/melius/WRF_v4.4/WPS/kiefer_landfill/SRTM_1s_300_30m_toParker
